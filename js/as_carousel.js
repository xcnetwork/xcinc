...
function tinyCarouselGallery(json) {
  document.write('<div id="tinycarousel"><div class="viewport"><img width="50" height="50" src="http://4.bp.blogspot.com/-T1K0fQGXHn8/T0pmUCTEjEI/AAAAAAAACN8/zJ1CEvvEzLo/s1600/new-ribbon.png" id="ribbon" /><ul class="overview">');
