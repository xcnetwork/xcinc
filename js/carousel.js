...
function tinyCarouselGallery(json) {
	document.write('<div id="tinycarousel"><div id="tinyarrow"><a href="#"><img class="buttons prev" src="'+ prevNav +'"/></a><a href="#"><img class="buttons next" src="'+ nextNav +'"/></a><span>'+ showText +' <scr" + "ipt type='text/javascript'>'+ days +';<\/scr" + "ipt></span></div><div class="viewport"><ul class="overview">');
