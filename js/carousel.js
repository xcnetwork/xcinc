...
function tinyCarouselGallery(json) {
  document.write('<div id="tinycarousel"><div id="tinyarrow"><a class="buttons prev" href="#">' + tinyprevNav + '</a><a class="buttons next" href="#">' + tinynextNav + '</a><span>' + showText + ' ' + numposts_g + ' ' + postText + '</span></div><div class="viewport"><ul class="overview">');
