...
document.write("<scr" + "ipt type='text/javascript' src='/feeds/posts/summary/default'") + "?max-results=" + num_posts + "&orderby=published&alt=json-in-script&callback=Terbaru'><\/scr" + "ipt>");