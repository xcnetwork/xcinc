...
function showResult(json) {
        ...
        skeleton += '<a title="Close" style="display:block;position:absolute;top:8px;right:10px;line-height:normal;text-decoration:none;color:inherit;font-size:150%;" href="#close" onclick="resultContainer.style.display=\'none\';return false;"><close></close></a><ol>';
        if (entry === "") {
