...
document.write('<div id="rc_label"><div class="rc_head"><h2>'+ judul +'</h2><span class='more_link'><a href="search/label/'+judul+'?&amp;max-results=8">'+judul+'</a></span></div><div class="viewport"><ul>');
