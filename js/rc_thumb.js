...
document.write('<div id="rc_label"><div class="rc_head"><h1>'+ judul +'</h1><span class="more_link"><a href="search/label/'+ label +'?&amp;max-results=16">'+ more +'</a></span></div><div class="viewport"><ul>');
